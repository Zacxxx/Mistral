...
import { Mic, Upload, DollarSign, AlertTriangle, Check, X, FileDown, BarChart2, ChevronDown, ChevronUp, MapPin, RefreshCw, GitCompare } from "lucide-react"
...
import { CostItem, ProjectType, SuggestedItem, type SimulationResult, type Material } from "@/types/quote"
import { fetchMaterialPrices, compareMaterialPrices, getRegionalPreferences, setRegionalPreferences, getCachedPrices } from "@/services/material-pricing"
...
export function QuoteEngine() {
  ...
  const convertToMaterials = (items: CostItem[]): Material[] => {
